...
{
    public static class InMemoryOpenBeerIngredientsDB
    {
        ...
        private static readonly List<HopRow> _hops = new List<HopRow>();
        public static IReadOnlyList<HopRow> Hops => _hops;
        ...
        public static void LoadData()
        {
            ...
            MiscUtils.ReadCsv<HopRow>(currentFolder, "hops.csv", row => _hops.Add(row));
